...
class getid3_writetags
{
	...
	public $tag_encoding       = 'UTF-8';   // text encoding used for tag data ('ISO-8859-1', 'UTF-8', 'UTF-16', 'UTF-16LE', 'UTF-16BE', )
...
throw new Exception('$this->overwrite_tags=false is known to be buggy in this version of getID3. Will be fixed in the near future, check www.getid3.org for a newer version.');
	...
	public function FormatDataForID3v1() {
		...
		$tag_data_id3v1['title']   =        getid3_lib::iconv_fallback($this->tag_encoding, 'UTF-8', implode(' ', (isset($this->tag_data['TITLE']      ) ? $this->tag_data['TITLE']       : array())));
		$tag_data_id3v1['artist']  =        getid3_lib::iconv_fallback($this->tag_encoding, 'UTF-8', implode(' ', (isset($this->tag_data['ARTIST']     ) ? $this->tag_data['ARTIST']      : array())));
		$tag_data_id3v1['album']   =        getid3_lib::iconv_fallback($this->tag_encoding, 'UTF-8', implode(' ', (isset($this->tag_data['ALBUM']      ) ? $this->tag_data['ALBUM']       : array())));
		$tag_data_id3v1['year']    =        getid3_lib::iconv_fallback($this->tag_encoding, 'UTF-8', implode(' ', (isset($this->tag_data['YEAR']       ) ? $this->tag_data['YEAR']        : array())));
		$tag_data_id3v1['comment'] =        getid3_lib::iconv_fallback($this->tag_encoding, 'UTF-8', implode(' ', (isset($this->tag_data['COMMENT']    ) ? $this->tag_data['COMMENT']     : array())));
		$tag_data_id3v1['track']   = intval(getid3_lib::iconv_fallback($this->tag_encoding, 'UTF-8', implode(' ', (isset($this->tag_data['TRACKNUMBER']) ? $this->tag_data['TRACKNUMBER'] : array()))));
